          ...
          <form action="#">
            <div className="p-6.5">
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white font-semibold text-lg">License No</label>
                <input
                  type="text"
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white font-semibold text-lg">Category</label>
                <input
                  type="text"
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white font-semibold text-lg">Validity</label>
                <textarea
                  rows={3}
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white font-semibold text-lg">Country</label>
                <input
                  type="text"
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white font-semibold text-lg">State</label>
                <input
                  type="text"
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white font-semibold text-lg">Upload document</label>
                <div
                  id="FileUpload_2"
