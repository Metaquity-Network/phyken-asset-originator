    ...
    <AdminLayout>
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
          ...
          <DashboardCardTwo imageSrc="" name="Number of assets uploaded" count={assetList.length} url="" />
          <DashboardCardTwo imageSrc="" name="Asset pending verification" count={assetList.length} url="" />
        </div>
        <div className="pt-10">
